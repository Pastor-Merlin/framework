...
namespace Framework
{
    public class MessageCtl : IController
    {
        protected IDictionary<string, Type> m_commandMap;
        protected IDictionary<IBaseView, List<string>> m_viewCmdMap;

        protected static volatile IController m_instance;
        protected readonly object m_syncRoot = new object();
        protected static readonly object m_staticSyncRoot = new object();

        protected MessageCtl()
        {
        ...
        public static IController Instance
        {
            get
            {
                if (m_instance == null)
                {
                    ...
                    {
                        if (m_instance == null) m_instance = new MessageCtl();
                    }
                }
                return m_instance;
            }
        ...
        protected virtual void InitializeController()
        {
            ...
            m_viewCmdMap = new Dictionary<IBaseView, List<string>>();
        }

        public virtual void ExecuteCommand(IMessage note)
        {
            Type commandType = null;
            List<IBaseView> views = null;
            lock (m_syncRoot)
            {
        ...
        public virtual void RegisterViewCommand(IBaseView view, string[] commandNames)
        {
            lock (m_syncRoot)
            {
        ...
        public virtual void RemoveViewCommand(IBaseView view, string[] commandNames)
        {
            lock (m_syncRoot)
            {
                if (m_viewCmdMap.ContainsKey(view))
